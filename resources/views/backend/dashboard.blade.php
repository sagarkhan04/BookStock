        ...
        >
          ...
          <div class="flex items-center space-x-4 mt-4 md:mt-0">
            <form action="{{ route('logout') }}" method="POST">
              @csrf
              <button type="submit" class="flex items-center space-x-2 px-4 py-2 bg-white border border-gray-200 rounded-lg text-gray-600 hover:text-red-600 hover:border-red-600 transition-all duration-200">
            ...
            <div class="p-6">
              ...
              <div class="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="p-4 border rounded-lg bg-gray-50">
                  ...
                  <p class="font-medium text-gray-800">{{ Auth::user()->updated_at->format('M d, Y') }}</p>
                </div>
              </div>
            </div>
          </div>
