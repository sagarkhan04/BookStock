...
<html lang="en">
  <head>
    ...
    <title>Edit Author | Interactive Cares</title>
      ...
      <main class="flex-1">
        ...
        <header class="bg-white shadow-sm">
          <div class="px-6 lg:px-8 py-4 flex items-center justify-between">
            ...
            <div class="relative">
              <button id="userMenuButton" onclick="toggleDropdown()" class="flex items-center space-x-2 px-4 py-2 rounded-lg text-gray-700 hover:bg-gray-100 transition-colors">
              ...
              <div
                id="userDropdown"
                class="dropdown-menu absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-lg border py-2 z-50"
              >
        ...
        <div class="max-w-2xl">
          <div class="bg-white rounded-xl shadow overflow-hidden">
            ...
            <form method="POST" action="{{ route('authors.update', $author->id) }}" class="p-6 space-y-6">
              @csrf
              @method('PUT')
              @if ($errors->any())
